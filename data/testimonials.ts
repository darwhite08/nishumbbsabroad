...
export const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    quote: "I was terrified about going to Russia — the cold weather, the language, being so far from home. Our team addressed every single concern before I even asked. Two years in, I can say it was the best decision of my life. The team even helped me find a great Indian mess near campus.",
  ...
  },
  {
    ...
    rating: 5,
    quote: "The counseling was incredibly detailed. They didn't just tell me which university — they explained WHY that university for my NEET score and budget. Our counselor has studied at TSMU herself so the advice was real, not just marketing talk.",
  ...
  },
  {
    ...
    currentYear: "2nd Year MBBS",
    rating: 5,
    quote: "I wanted USMLE prep and Philippines was the clear answer. Our counselor's guidance was specific and practical — she had studied there herself. Manila is a vibrant, English-speaking city and I absolutely love it here.",
